...
1. **Classifier** — @docs/sdlc/phase.g.reporeorg/02-classifier-agent.md
2. **Code Files** — @docs/sdlc/phase.g.reporeorg/03-code-files-agent.md
3. **Test Files** — @docs/sdlc/phase.g.reporeorg/04-test-files-agent.md
4. **Docs Files** — @docs/sdlc/phase.g.reporeorg/05-docs-files-agent.md
5. **Database Files** — @docs/sdlc/phase.g.reporeorg/06-database-files-agent.md
6. **Design/Generated** — @docs/sdlc/phase.g.reporeorg/07-design-generated-agent.md
7. **Scripts/Config** — @docs/sdlc/phase.g.reporeorg/08-scripts-config-agent.md
8. **Validation** — @docs/sdlc/phase.g.reporeorg/09-validation-agent.md
</agent_pipeline>
...
- Database Files Agent — @docs/sdlc/phase.g.reporeorg/06-database-files-agent.md
- Docs Files Agent — @docs/sdlc/phase.g.reporeorg/05-docs-files-agent.md
- Design/Generated Agent — @docs/sdlc/phase.g.reporeorg/07-design-generated-agent.md
(These 3 can run in parallel — no dependencies between them)

**Phase 3: Code Files** (after DB and Design agents finish)
Load @docs/sdlc/phase.g.reporeorg/03-code-files-agent.md

**Phase 4: Test Files** (after Code Files — tests depend on source locations)
...
- move-manifest.json — Complete history of all file moves
- validation-report.json — Build and test results
- summary.md — Human-readable summary of reorganization
