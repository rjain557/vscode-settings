...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  echo "=== $plan ==="
  PLAN_STRUCTURE=$(node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js verify plan-structure "$plan")
  echo "$PLAN_STRUCTURE"
done
```
...
```bash
MUST_HAVES=$(node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js frontmatter get "$PLAN_PATH" --field must_haves)
```
...
```bash
PLAN_STRUCTURE=$(node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js verify plan-structure "$PLAN_PATH")
```
