...
```bash
PHASE_INFO=$(node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js find-phase "${PHASE}" --raw)
```
