...
if [ -f "./.claude/get-shit-done/VERSION" ]; then
  ...
  echo "LOCAL"
elif [ -f C:/Users/rjain/.claude/get-shit-done/VERSION ]; then
  cat C:/Users/rjain/.claude/get-shit-done/VERSION
  echo "GLOBAL"
else
  echo "UNKNOWN"
fi
...
(Paths are relative to your install location: `C:/Users/rjain/.claude/` for global, `./.claude/` for local)
...
**If GLOBAL install:**
```bash
rm -f C:/Users/rjain/.claude/cache/gsd-update-check.json
```
</step>
