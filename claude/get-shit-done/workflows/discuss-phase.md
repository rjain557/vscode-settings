...
```bash
INIT=$(node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js init phase-op "${PHASE}")
```
...
```bash
node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js commit "docs(${padded_phase}): capture phase context" --files "${phase_dir}/${padded_phase}-CONTEXT.md"
```
