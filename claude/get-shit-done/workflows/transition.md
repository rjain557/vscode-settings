...
```bash
TRANSITION=$(node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js progress bar --raw)
```
