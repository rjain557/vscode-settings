...
PHASES=$(node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js phases list)
...
```bash
node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md
```
