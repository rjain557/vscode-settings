...
```bash
INIT=$(node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js init execute-phase "${PHASE_ARG}")
```
...
```bash
PLAN_INDEX=$(node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js phase-plan-index "${PHASE_NUMBER}")
```
...
2. **Spawn ONE executor agent and WAIT for it to complete:**
   ...
   Task(
     ...
     prompt="
       ...
       @C:/Users/rjain/.claude/get-shit-done/references/checkpoints.md
       @C:/Users/rjain/.claude/get-shit-done/references/tdd.md
       </execution_context>
...
```bash
node C:/Users/rjain/.claude/get-shit-done/bin/gsd-tools.js commit "docs(phase-{X}): complete phase execution" --files .planning/ROADMAP.md .planning/STATE.md .planning/phases/{phase_dir}/*-VERIFICATION.md .planning/REQUIREMENTS.md
```
</step>
